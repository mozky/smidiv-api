...
module.exports = {
  ...
  getUser: function (req, res) {
    ...
    const query = User.findOne({ 'username': req.swagger.params.username.value, 'deleted': false });
  ...
  addUser: function (req, res) {
    ...
    newUser.save(function (err, newUser) {
      if (err) {
        ...
        var token = jwt.sign({ user: newUser }, config.secret, {
  ...
  updateUser: function (req, res) {
    ...
    User.findOneAndUpdate({username: username}, { $set: updates }, { new: true }, function (err, updatedUser) {
      if (err || !updatedUser) {
  ...
  deleteUser: function (req, res) {
    ...
    User.findOneAndUpdate({username: username}, { $set: { deleted: true, dateUpdated: new Date()} }, { new: true }, function (err, deletedUser) {
      if (err || !deletedUser) {
